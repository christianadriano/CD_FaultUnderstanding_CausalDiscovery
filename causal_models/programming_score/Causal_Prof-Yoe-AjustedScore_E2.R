" 
E2 Causal Models of Adjusted Score based on Profession, Years of Experience, and Age

Causal models that include Profession (Prf) and Years of Programming Experience (Yoe)
as covariates of the Programming Adjusted Score obtained in the qualification test.

The goal of the current study is to know whether there is any additional value in 
knowing a certain variable, once I already know all of the other predictor variables?
...
after knowing the profession category, what additional value I gain in knowing:
