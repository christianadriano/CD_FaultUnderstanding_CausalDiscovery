"
Causal effects of Skill and Compleixty on Accuracy of Fault Understanding Task

To compute the causal effect we need to identify the backdoor paths that 
can bias the cause-effect of Programmre Skill and Code Complexity on Accuracy. 
For that we applied the backdoor criterion [Peals 2009], which consists of finding 
a set of variables Z that blocks every path between the exposure variable X
